...
These docs ship in both packages under node_modules/@matchbox-ai/core/docs and node_modules/@matchbox-ai/train/docs. Use the installed version when assisting an application author. The bundled agent-skill.md provides the corresponding coding-agent workflow.
