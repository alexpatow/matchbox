...
These docs ship in all three packages under node_modules/@matchbox-ai/{core,train,cli}/docs. Use the installed version when assisting an application author. The bundled agent-skill.md provides the corresponding coding-agent workflow.
