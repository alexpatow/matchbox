...
6. Use the CLI or programmatic train to apply validation gates, measure results, and package weights. Report failures honestly. Never fabricate benchmark figures.
